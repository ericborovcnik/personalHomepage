...
Ext.extend(Ext.ux.NumericField, Ext.form.NumberField, {
	...
	getFormattedValue: function(v) {
        ...
        var r = /(\d+)(\d{3})/;
          ...
          v = whole + (ps[1] ? this.decimalSeparator + ps[1] : '');
				...
				return String.format('{0}{1}{2}{3}', (neg ? '-' : ''), (Ext.isEmpty(this.currencySymbol) ? '' : this.currencySymbol + ' '), v, Ext.isEmpty(this.percentSymbol) ? '' : this.percentSymbol);
			}
		},
    /**
    ...
    parseValue: function(v){
    	//	Replace the currency symbol, thousand separator & percentSymbol
    ...
    removeFormat: function(v){
    	if (Ext.isEmpty(v) || !this.hasFormat()) 
    		...
    		v = v.replace(this.percentSymbol, '');
